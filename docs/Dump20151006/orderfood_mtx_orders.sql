...
--
-- Table structure for table `mtx_orders`
--
...
--
-- Dumping data for table `mtx_orders`
--

LOCK TABLES `mtx_orders` WRITE;
/*!40000 ALTER TABLE `mtx_orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `mtx_orders` ENABLE KEYS */;
UNLOCK TABLES;
