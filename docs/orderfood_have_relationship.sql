...
CREATE TABLE `mtx_branch` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_CAB0DCA8727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `mtx_branch` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `mtx_branch_language` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_64D3050082F1BAF4` FOREIGN KEY (`language_id`) REFERENCES `mtx_language` (`id`),
  CONSTRAINT `FK_64D30500DCD6CC49` FOREIGN KEY (`branch_id`) REFERENCES `mtx_branch` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `mtx_mediacategory` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  FOREIGN KEY (`parent_id`) REFERENCES `mtx_mediacategory` (`id`)
...
CREATE TABLE IF NOT EXISTS `mtx_mediacategory_language` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  FOREIGN KEY (`mediacategory_id`) REFERENCES `mtx_mediacategory` (`id`),
  FOREIGN KEY (`language_id`) REFERENCES `mtx_language` (`id`)
...
CREATE TABLE `mtx_product` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_863E1445DCD6CC49` FOREIGN KEY (`branch_id`) REFERENCES `mtx_branch` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `mtx_comment` (
  ...
  PRIMARY KEY (`id`),  
  CONSTRAINT `FK_C10042846C8A81A9` FOREIGN KEY (`product_id`) REFERENCES `mtx_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `mtx_comment_language` (
  ...
  PRIMARY KEY (`id`),  
  CONSTRAINT `FK_70AE6D1782F1BAF4` FOREIGN KEY (`language_id`) REFERENCES `mtx_language` (`id`),
  CONSTRAINT `FK_70AE6D17F8697D13` FOREIGN KEY (`comment_id`) REFERENCES `mtx_comment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `mtx_daily_menu_detail` (
  ...
  `product_id` int(11) NOT NULL,  
  PRIMARY KEY (`id`),
  FOREIGN KEY (`daily_menu_id`) REFERENCES `mtx_daily_menu` (`id`),
  FOREIGN KEY (`product_id`) REFERENCES `mtx_product` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;